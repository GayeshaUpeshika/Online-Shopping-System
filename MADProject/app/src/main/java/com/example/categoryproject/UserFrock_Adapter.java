...
public class UserFrock_Adapter extends FirebaseRecyclerAdapter<UserFrock_Model,UserFrock_Adapter.myviewholder> {
    public UserFrock_Adapter(FirebaseRecyclerOptions<UserFrock_Model> options) {

        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myviewholder holder, int position, @NonNull UserFrock_Model model) {
