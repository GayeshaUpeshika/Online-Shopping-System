...
public class UserBlouse_Adapter extends FirebaseRecyclerAdapter<UserBlouse_Model,UserBlouse_Adapter.myviewholder> {
    public UserBlouse_Adapter(FirebaseRecyclerOptions<UserBlouse_Model> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myviewholder holder, int position, @NonNull UserBlouse_Model model) {
