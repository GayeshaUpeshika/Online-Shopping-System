...
public class AdminSkirt_adddata extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_skirt_adddata);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(),AdminSkirt_Page.class));
                finish();
            }
        });
    ...
    private void processinsert(){
        ...
        FirebaseDatabase.getInstance().getReference().child("skirtCategory").push()
                .setValue(map)
