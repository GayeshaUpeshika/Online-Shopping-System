...
public class AdminSkirt_Adapter extends FirebaseRecyclerAdapter<AdminSkirt_Model,AdminSkirt_Adapter.myviewholder> {
    public AdminSkirt_Adapter(FirebaseRecyclerOptions<AdminSkirt_Model> options) {

        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myviewholder holder, @SuppressLint("RecyclerView") int position, @NonNull AdminSkirt_Model model) {
            ...
            public void onClick(View view) {
                ...
                submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("skirtCategory")
