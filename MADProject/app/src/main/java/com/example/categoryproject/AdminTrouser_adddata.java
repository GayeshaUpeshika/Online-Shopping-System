...
public class AdminTrouser_adddata extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_trouser_adddata);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(),AdminTrouser_Page.class));
                finish();
            }
        });
    ...
    private void processinsert(){
        ...
        FirebaseDatabase.getInstance().getReference().child("trousesCategory").push()
                .setValue(map)
