...
public class AdminFrock_Adapter extends FirebaseRecyclerAdapter<AdminFrock_Model,AdminFrock_Adapter.myviewholder> {

    public AdminFrock_Adapter(FirebaseRecyclerOptions<AdminFrock_Model> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myviewholder holder, @SuppressLint("RecyclerView") final int position, @NonNull AdminFrock_Model model) {
                ...
                public void onClick(View view) {
                    ...
                    submit.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("frockCategory")
