...
public class AdminBlouse_adddata extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_blouse_adddata);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(),AdminBlouse_Page.class));
                finish();
            }
        });
    ...
    private void processinsert(){
        ...
        FirebaseDatabase.getInstance().getReference().child("blouseCategory").push()
                .setValue(map)
