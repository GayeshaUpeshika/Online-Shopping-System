...
public class AdminTrouser_Adapter extends FirebaseRecyclerAdapter<AdminTrouser_Model,AdminTrouser_Adapter.myviewholder> {
    public AdminTrouser_Adapter(FirebaseRecyclerOptions<AdminTrouser_Model> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myviewholder holder, @SuppressLint("RecyclerView") final int position, @NonNull AdminTrouser_Model model) {
            ...
            public void onClick(View view) {
                ...
                submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("trousesCategory")
