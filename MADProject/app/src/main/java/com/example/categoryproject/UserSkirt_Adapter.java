...
public class UserSkirt_Adapter extends FirebaseRecyclerAdapter<UserSkirt_Model,UserSkirt_Adapter.myviewholder> {
    public UserSkirt_Adapter(FirebaseRecyclerOptions<UserSkirt_Model> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myviewholder holder, int position, @NonNull UserSkirt_Model model) {
